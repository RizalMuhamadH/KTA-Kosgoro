                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label> Source </label>
                                        <input type="text" class="form-control @error('source') is-invalid @enderror" name="source" required minlength="10" maxlength="40" value="{{old('source')}}">
                                        @error('source')
                                            <div class="alert alert-danger">
                                                {{$message}}
                                            </div>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="url" class="form-control @error('source_link') is-invalid @enderror" name="source_link" required minlength="10" maxlength="40" value="{{old('source_link')}}">
                                        @error('source_link')
                                            <div class="alert alert-danger">
                                                {{$message}}
                                            </div>
