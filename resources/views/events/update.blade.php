    ...
    <section class="section">
        ...
        <form method="POST" action="{{route('events.update')}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('start_date') is-invalid @enderror" name="start_date" required value="{{old('start_date',$data->start_date)}}">
                                        @error('start_date')
                                            <div class="alert alert-danger">
                                                {{$message}}
                                            </div>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('end_date') is-invalid @enderror" name="end_date" required value="{{old('end_date',$data->end_date)}}">
                                        @error('end_date')
                                            <div class="alert alert-danger">
                                                {{$message}}
                                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <img src='{{asset("storage/events/$data->id/$data->thumbnail")}}' class="w-100">
            ...
            <div class="card-footer bg-white text-right">
                <input type="hidden" readonly name="id" value="{{$data->id}}" required>
